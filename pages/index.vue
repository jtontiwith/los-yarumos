            ...
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#">
                ...
                <img
                  ...
                  alt=""
                />-->
                <h1 class="text-2xl font-bold">Los Yarumos</h1>
              </a>
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            <h1>
              ...
              >
                <span class="block text-gray-900">Quede con nosotros</span>
                <span class="block text-green-600">en un arbol</span>
              </span>
            </h1>
            <p
              class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl"
            >
              Despu&eacute;s de a&ntilde;os de planeaci&oacute;n y esfuerzo
              estamos felizes de ofrecer nuestra primera casa en los arboles. La
              obra esta 95% terminado y estar&aacute; disponsible a partir de
              enero 2022!
            </p>
            <div
            ...
            >
              <p class="text-base font-medium text-gray-900">
                Deje su correo para estar notificado.
              </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <img class="w-full" src="/treehouse_far_view.JPG" alt="" />
              </button>
            </div>
          </div>
        </div>
